...
mongoose.connect(mongoConfig.dbName);
var connected = false;
...
mongoCRUD.prototype.initializeModel = function () {
    if(this.mongoModel == undefined){
        this.mongoModel = this.mongoSchema.getModel(mongoose);
    }
}

var addInMongo = function(mongo, data, query, callback) {
...
var searchInMongo = function(mongo,data, query, callback) {
    mongo.initializeModel();
...
var removeInMongo = function(mongo,data, query, callback) {
    mongo.initializeModel();
