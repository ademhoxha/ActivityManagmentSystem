...
export class SchedulerComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    var constrains = this.schedulerBuilder.constraintsEvents();
    if (constrains)
      this.events = this.events.concat(constrains);
  }
  ...
  addJobToEvent(ret) {
    // var job = ret.selectedJob;
    var job = ret.selectedJob.projectName + " " + ret.selectedJob.taskName + " " + ret.selectedJob.jobName;
    this.display = false;
